    ...
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            if (Debugger.IsAttached)
            {
                ...
                _buttonStart.Enabled = true; // TODO: remove
            }
        }
        ...
        private void button_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show($"clicked on {senderbutton.Text}");
        ...
        {
            //string text1 = _txtCol1.Text;
            //string text2 = _txtCol2.Text;
            //string text3 = _txtCol3.Text;
            //// "01010100"
            ...
            //else if(b1 == '1') {
            //    // click on button b1
            //    BeginInvoke(() => button_Click(button1, EventArgs.Empty));
            //}
            ...
            //    else if (c == '1') {
            //        // click on button [i]
            //        BeginInvoke(() => button_Click(buttons[i], EventArgs.Empty));
            //    }
            //    else {
            //        // do nothing
            //    }
            ...
            if (textFromFirstColumn1 == "") 
            {
                textFromFirstColumn1 = "00000000";
            }
            if (textFromFirstColumn2 == "") 
            {
                textFromFirstColumn2 = "00000000";
            }
            if (textFromFirstColumn2 == "") 
            {
                textFromFirstColumn2 = "00000000";
            ...
            foreach (char c in binaryInput)
            {
                if (c != '0' && c != '1')
                {
                    MessageBox.Show("Enter only binary code");
                }
            }
            ...
            for (int i = 0; i < binaryInput.Length; i++)
            {
                if (binaryInput[i] == '1')
                {
                    ...
                    int iTmp = i;
                    BeginInvoke(() => button_Click(buttons[iTmp], EventArgs.Empty));
                }
                else
                {
                    buttons[i].BackColor = default_backcolor;
